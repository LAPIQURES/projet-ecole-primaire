...
export const createUserAPI = (data) => API.post('/auth/users/create', data);
export const listUsersAPI = () => API.get('/auth/users');
export const toggleUserAPI = (data) => API.post('/auth/users/toggle', data);
export const resetPasswordAPI = (data) => API.post('/auth/users/reset-password', data);

// ── Rapports Discipline (Enseignant) ─────────────────────────────────────────
export const createRapportEleveAPI = (data) => API.post('/rapports/eleves/create', data);

// ── Années académiques ────────────────────────────────────────────────────────
export const getAnneesAcademiquesAPI = () => API.get('/years');
export const createAnneeAcademiqueAPI = (data) => API.post('/years', data);
export const updateAnneeAcademiqueAPI = (id, data) => API.put(`/years/${id}`, data);
